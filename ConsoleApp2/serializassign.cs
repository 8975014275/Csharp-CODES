...
namespace ConsoleApp2
{
    ...
    internal class PROseri
    {
        ...
        static void SoapSerializationWrite(Products pt)
        {
            try
            {
                FileStream fs = new FileStream(@"D:\dotnet mvc\TestFolder1\SoapFile1.soap", FileMode.Create, FileAccess.Write);
        ...
        static void SoapSerializationRead()
        {
            try
            {
                FileStream fs = new FileStream(@"D:\dotnet mvc\TestFolder1\SoapFile1.soap", FileMode.Open, FileAccess.Read);
                SoapFormatter sf = new SoapFormatter();
        ...
        static void XmlSerializationWrite(Products pt)
        {
            try
            {
                FileStream fs = new FileStream(@"D:\dotnet mvc\TestFolder1\XmlFile1.xml", FileMode.Create, FileAccess.Write);
        ...
        static void XmlSerializationRead()
        {
            try
            {
                FileStream fs = new FileStream(@"D:\dotnet mvc\TestFolder1\XmlFile1.xml", FileMode.Open, FileAccess.Read);
                XmlSerializer xs = new XmlSerializer(typeof(Products));
        ...
        static void BinerySerializationWrite(Products pt)
        {
            try
            {
                FileStream fs = new FileStream(@"D:\dotnet mvc\TestFolder1\BinaryFile1.dat", FileMode.Create, FileAccess.Write);
        ...
        static void BinerySerializationRead()
        {
            try
            {
                FileStream fs = new FileStream(@"D:\dotnet mvc\TestFolder1\BinaryFile1.dat", FileMode.Open, FileAccess.Read);
                BinaryFormatter bf = new BinaryFormatter();
